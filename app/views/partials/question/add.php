        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Add New Question</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="question-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-horizontal needs-validation" action="<?php print_link("question/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-question_count"  value="<?php  echo $this->set_field_value('question_count',''); ?>" type="number" placeholder="Enter Question Count" step="1"  required="" name="question_count"  class="form-control " />
                                                    ...
                                                    <div class="form-group ">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        ...
                                                                        <textarea placeholder="Enter Question" id="ctrl-question"  required="" rows="" name="question" class=" form-control"><?php  echo $this->set_field_value('question',''); ?></textarea>
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-correct_answers"  value="<?php  echo $this->set_field_value('correct_answers',''); ?>" type="text" placeholder="Enter Correct Answers"  required="" name="correct_answers"  class="form-control " />
