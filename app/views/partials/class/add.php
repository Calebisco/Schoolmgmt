            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="class-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-horizontal needs-validation" action="<?php print_link("class/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                ...
                                                <textarea placeholder="Enter Name Numeric" id="ctrl-name_numeric"  required="" rows="" name="name_numeric" class=" form-control"><?php  echo $this->set_field_value('name_numeric',''); ?></textarea>
                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
