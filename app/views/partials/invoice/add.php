        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Add New Invoice</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="invoice-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-horizontal needs-validation" action="<?php print_link("invoice/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                    ...
                                    <div class="form-group ">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        ...
                                                        <textarea placeholder="Enter Amount Paid" id="ctrl-amount_paid"  required="" rows="" name="amount_paid" class=" form-control"><?php  echo $this->set_field_value('amount_paid',''); ?></textarea>
                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        ...
                                                        <textarea placeholder="Enter Due" id="ctrl-due"  required="" rows="" name="due" class=" form-control"><?php  echo $this->set_field_value('due',''); ?></textarea>
                                                        <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-creation_timestamp"  value="<?php  echo $this->set_field_value('creation_timestamp',''); ?>" type="number" placeholder="Enter Creation Timestamp" step="1"  required="" name="creation_timestamp"  class="form-control " />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            ...
                                                            <textarea placeholder="Enter Payment Timestamp" id="ctrl-payment_timestamp"  required="" rows="" name="payment_timestamp" class=" form-control"><?php  echo $this->set_field_value('payment_timestamp',''); ?></textarea>
                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            ...
                                                            <textarea placeholder="Enter Payment Method" id="ctrl-payment_method"  required="" rows="" name="payment_method" class=" form-control"><?php  echo $this->set_field_value('payment_method',''); ?></textarea>
                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            ...
                                                            <textarea placeholder="Enter Payment Details" id="ctrl-payment_details"  required="" rows="" name="payment_details" class=" form-control"><?php  echo $this->set_field_value('payment_details',''); ?></textarea>
                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
