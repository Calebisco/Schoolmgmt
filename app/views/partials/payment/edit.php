            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form form-horizontal needs-validation" action="<?php print_link("payment/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-expense_category_id"  value="<?php  echo $data['expense_category_id']; ?>" type="number" placeholder="Enter Expense Category Id" step="1"  required="" name="expense_category_id"  class="form-control " />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    ...
                                                    <textarea placeholder="Enter Payment Type" id="ctrl-payment_type"  required="" rows="" name="payment_type" class=" form-control"><?php  echo $data['payment_type']; ?></textarea>
                                                    <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-invoice_id"  value="<?php  echo $data['invoice_id']; ?>" type="number" placeholder="Enter Invoice Id" step="1"  required="" name="invoice_id"  class="form-control " />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            ...
                                                            <textarea placeholder="Enter Method" id="ctrl-method"  required="" rows="" name="method" class=" form-control"><?php  echo $data['method']; ?></textarea>
                                                            <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
