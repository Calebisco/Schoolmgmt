        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">View  Examquestion</h3>
                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> Examquestion Id :</th>
                                        <td class="value"> <?php echo $data['examquestion_id']; ?> </td>
                                    </tr>
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("examquestion/edit/$data[examquestion_id]"); ?>">
                                <i class="fa fa-edit"></i> 
                            </a>
                            
                            
                            <a class="btn btn-sm btn-danger recordDeletePromptAction"  href="<?php print_link("examquestion/delete/$data[examquestion_id]/?csrf_token=$csrf_token"); ?>" >
