        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Add New Task Manager</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="task_manager-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-horizontal needs-validation" action="<?php print_link("task_manager/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                ...
                                                <textarea placeholder="Enter Priority" id="ctrl-priority"  required="" rows="" name="priority" class=" form-control"><?php  echo $this->set_field_value('priority',''); ?></textarea>
                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                ...
                                                <textarea placeholder="Enter User" id="ctrl-user"  required="" rows="" name="user" class=" form-control"><?php  echo $this->set_field_value('user',''); ?></textarea>
                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
