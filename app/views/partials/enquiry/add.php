        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Add New Enquiry</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="enquiry-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-horizontal needs-validation" action="<?php print_link("enquiry/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                ...
                                                <textarea placeholder="Enter Mobile" id="ctrl-mobile"  required="" rows="" name="mobile" class=" form-control"><?php  echo $this->set_field_value('mobile',''); ?></textarea>
                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                ...
                                                <textarea placeholder="Enter Whom To Meet" id="ctrl-whom_to_meet"  required="" rows="" name="whom_to_meet" class=" form-control"><?php  echo $this->set_field_value('whom_to_meet',''); ?></textarea>
                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
