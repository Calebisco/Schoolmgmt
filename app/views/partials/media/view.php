        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">View  Media</h3>
                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> Media Id :</th>
                                        <td class="value"> <?php echo $data['media_id']; ?> </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th class="title"> Mlink :</th>
                                        <td class="value"> <?php echo $data['mlink']; ?> </td>
                                    </tr>
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("media/edit/$data[media_id]"); ?>">
                                <i class="fa fa-edit"></i> 
                            </a>
                            
                            
                            <a class="btn btn-sm btn-danger recordDeletePromptAction"  href="<?php print_link("media/delete/$data[media_id]/?csrf_token=$csrf_token"); ?>" >
