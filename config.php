<?php
	...
	define('APP_ID',"9077da6eb01753b9638bb74ddfbec804");
	...
	define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['admin_id'] : null ));
